...
sleep 2
git clone https://github.com/pimpim888/pimpmbot.git/SITEX
git clone https://github.com/pimpim888/pimpmbot.git/apikey
git clone https://github.com/pimpim888/pimpmbot.git/testek
cd pimpim3.0
chmod +x git.sh
echo "$verde"
